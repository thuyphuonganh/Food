...
<div class="container">
    <h2>Danh mục món ăn: {{ $category->name ?? 'Không xác định' }}</h2>

    <div class="row">
        @forelse ($products as $product)
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4"> {{-- 4 món / dòng --}}
                <div class="card card-hover shadow mb-3 me-1 h-100 d-flex flex-column">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between mt-2" style="flex-grow: 1;">
                            ...
                            <p class="card-text price mt-1" style="color: #CA6702">Giá: {{ number_format($product->price, 0, ',', '.') }}đ</p>
    ...
    @empty
        <div class="col-9">
            <h5 class="text-center">Không có món ăn</h5>
        </div>
    @endforelse
</div>
</div>
